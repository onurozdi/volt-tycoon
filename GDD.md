...
- **Fiziksel mantık (19.07.2026 revizyonu — kullanıcı tasarımı):** araç başına ADET sıralaması her reçetede **Çelik > Alüminyum > Lityum > Çip** (bir arabada tonlarca çelik, birkaç çip); birim FİYAT tam tersi: çelik $2, alüminyum $6, lityum $40, **çip $300**. Kademeli giriş: garaj çelik(+alüminyum), lityum econoev'den, çip fairwaygo'dan. Maliyet yine satış fiyatının **~%20'si** (11 araçta %18,2-20,1 doğrulandı).
- **Malzemeye özgü depolar:** kapasite = tesis tabanı × malzeme oranı (çelik 1 / alüminyum 0,3 / lityum 0,03 / çip 0,003) — çelik deposu dev, çip rafı küçük; her malzemenin "tam depo kaç saat yeter" süresi yaklaşık eşit. Örn. garaj: 8K/2,4K/240/24 → giga: 8B/2,4B/240M/24M. Perakende parti (+%10 kapasite) maliyetleri dengeli: garajda +800 çelik $1,6K ≈ +3 çip $900.
- **Depo**: hammadde başına kapasite, açık en büyük tesisle büyür (**8K → 120K → 40M → 8B**). Eğri "tesisle rahatlar": tam depo tam üretimde yaklaşık garage ~15dk (aktif ilgi/öğrenme) → workshop ~1sa → factory ~3sa → giga ~6-8sa (offline tavanıyla uyumlu) yeter — 2. tesisten itibaren oyuncu hammaddeye giderek daha seyrek bakar, otomatize ettiğini hisseder; darlık hissi yok ama tamamen salınmış da değil (18.07.2026 ayarı).
- **Piyasayı sarsan haberler** (test geri bildirimi #2, 18.07.2026): süreli olaylar artık hammadde piyasasını ve talebi vurur. **matPrice şokları** (fiyat çarpanı normal bandın dışına iter; zam=KÖTÜ kırmızı, ucuzluk=İYİ yeşil): lityum grevi ×2,8 / dev lityum yatağı ×0,5; çip krizi ×2,2 / stok eritme ×0,55; çelik kotası ×2 / damping ×0,5; boksit krizi ×2 / geri dönüşüm rekoru ×0,55 (120-150 sn). **Talep dalgaları**: hükümet EV vergisi (satış fiyatı ×0,8), Hürmüz Boğazı kapandı (satış hızı ×2 — benzin krizi), EV yangını manşetlerde (satış hızı ×0,7). Şok fiyatı elle alım + DOLDUR + Tedarik Müdürü dahil her alıma işler — "grev öncesi ucuza stokla" gerçek bir strateji olur. Şok, ilgili malzemeyi kullanan açık hat yoksa havuza girmez.
- **Hediye hammadde olayları** (anlık popup, tesise göre ton — miktar depo kapasitesinin oranı): garage'da hurdalıkçı/komşu çelik bırakır (%20-30), workshop'ta belediye alüminyum fazlası ve kapanan elektronikçinin çipleri (%25-30), factory'de iflas eden rakibin depo tasfiyesi ve limanda sahipsiz konteyner (%30-35), giga'da devlet metal geri dönüşüm haklarını bedelsiz verir ve dost ülke lityum imtiyazı hibe eder (%35-40). Hediye, ortalama alış maliyetini de düşürür; depo ≥%85 doluysa veya o malzemeyi kullanan açık hat yoksa olay havuza girmez. Home'da kompakt stok şeridi (azalınca kızarır, dokununca Market'e götürür); araç kartında birim reçete satırı (depo yetmeyince kızarır).
...
- **Araç başı gider muhasebesi:** depo, **ağırlıklı ortalama alış maliyeti** tutar; üretim malzeme tükettiğinde maliyet o aracın giderine (`line.spent`) yazılır — İstatistik'teki araç başı kâr/zarar hammaddeyi içerir. Ucuza stoklayan oyuncunun araç gideri gerçekten düşer (FIFO yerine ortalama maliyet: basit ve adil). Müdürün offline/JIT alımları da aynı şekilde araca işlenir.
- **Tedarik Müdürü** ($40K, tek sefer): **tam zamanında alım** — üretim başlarken yalnızca o partinin eksiğini **+%10 primle** alır (araç 2 lityum istiyorsa 2 lityum), asla fazlasını stoklamaz; üretim durmaz, offline'da da çalışır (gideri Welcome Back'te "🏗 −$X" satırı). Ucuza stoklama kararı ve DOLDUR düğmesi oyuncunun elindedir — müdür bu kararı gasp etmez. Müdürsüz offline: üretim depodakiyle sınırlı.
