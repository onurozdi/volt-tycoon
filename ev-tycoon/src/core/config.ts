...
export const LOCATIONS: LocationDef[] = [
  ...
  { id: 'factory', nameKey: 'loc.factory', unlockCost: 5_000_000, unlockGems: 25, staffCap: 20, icon: 'factory' },
  { id: 'gigafactory', nameKey: 'loc.gigafactory', unlockCost: 250_000_000, unlockGems: 30, staffCap: 30, icon: 'giga' },
];
...
export const LOANS: LoanDef[] = [
  ...
  { id: 'loan_garage2', locationId: 'garage', principal: 6000, rate: 0.35, installments: 16, intervalSec: 120 },
  { id: 'loan_workshop', locationId: 'workshop', principal: 80_000, rate: 0.35, installments: 12, intervalSec: 120 },
  { id: 'loan_workshop2', locationId: 'workshop', principal: 500_000, rate: 0.4, installments: 16, intervalSec: 180 },
  { id: 'loan_factory', locationId: 'factory', principal: 8_000_000, rate: 0.4, installments: 16, intervalSec: 180 },
  { id: 'loan_factory2', locationId: 'factory', principal: 50_000_000, rate: 0.45, installments: 20, intervalSec: 240 },
  { id: 'loan_giga', locationId: 'gigafactory', principal: 600_000_000, rate: 0.5, installments: 20, intervalSec: 240 },
  { id: 'loan_giga2', locationId: 'gigafactory', principal: 2_500_000_000, rate: 0.55, installments: 24, intervalSec: 300 },
];
